...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  error,TResult Function( List<Store> stores)?  loaded,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Error() when error != null:
return error(_that.message);case _Loaded() when loaded != null:
return loaded(_that.stores);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  error,required TResult Function( List<Store> stores)  loaded,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  error,TResult? Function( List<Store> stores)?  loaded,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loading() when loading != null:
return loading();case _Error() when error != null:
...
class _Initial implements StoreState {
  const _Initial();
...
class _Loading implements StoreState {
  const _Loading();
...
class _Error implements StoreState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $StoreStateCopyWith<$Res> {
...
class _Loaded implements StoreState {
  const _Loaded({required final  List<Store> stores}): _stores = stores;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&const DeepCollectionEquality().equals(other._stores, _stores));
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $StoreStateCopyWith<$Res> {
