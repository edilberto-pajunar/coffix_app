...
class _Success implements ReferralState {
...
@override
String toString() {
  return 'ReferralState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $ReferralStateCopyWith<$Res> {
