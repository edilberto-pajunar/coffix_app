...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModifierState);
}
...
/// @nodoc
class $ModifierStateCopyWith<$Res>  {
$ModifierStateCopyWith(ModifierState _, $Res Function(ModifierState) __);
}


/// Adds pattern-matching-related methods to [ModifierState].
extension ModifierStatePatterns on ModifierState {
...
class _Initial implements ModifierState {
  const _Initial();
...
class _Loading implements ModifierState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $ModifierStateCopyWith<$Res> {
...
class _Error implements ModifierState {
...
@override
String toString() {
  return 'ModifierState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ModifierStateCopyWith<$Res> {
